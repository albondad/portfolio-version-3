      ...
      <>
        ...
        <div className="bg-albondadBlack pt-128px pb-128px">
          <div className="body-contentPadding skills-container">
            <div className="heading-1 foColor-albondadWhite foWeight-lighter pl-8px mb-16px skills-title">SKILLS</div>
            <div>
              <Skills />
            </div>
          </div>
        ...
        <div className="bg-albondadGray pt-128px pb-128px">
          <div className="body-contentPadding">
            <div className="heading-1 foColor-albondadBlack foWeight-lighter pl-8px mb-16px projects-title">PROJECTS</div>
            <Projects
